...
const CommentBox = ({ selectedBlog }) => {
    ...
    const getAllCommentsOfBlog = async () => {
      try {
        const res = await axios.get(
          `https://balanza-backend-8dr2.onrender.com/api/v1/comment/${selectedBlog._id}/comment/all`
        );
  ...
  const commentHandler = async () => {
    try {
      const res = await axios.post(
        `https://balanza-backend-8dr2.onrender.com/api/v1/comment/${selectedBlog._id}/create`,
        { content },
        {
          headers: {
  ...
  const deleteComment = async (commentId) => {
    try {
      const res = await axios.delete(
        `https://balanza-backend-8dr2.onrender.com/api/v1/comment/${commentId}/delete`,
        {
          withCredentials: true,
        }
      );
  ...
  const editCommentHandler = async (commentId) => {
    try {
      const res = await axios.put(
        `https://balanza-backend-8dr2.onrender.com/api/v1/comment/${commentId}/edit`,
  ...
  const likeCommentHandler = async (commentId) => {
    try {
      const res = await axios.get(
        `https://balanza-backend-8dr2.onrender.com/api/v1/comment/${commentId}/like`,
        {
          withCredentials: true,
        }
      );
